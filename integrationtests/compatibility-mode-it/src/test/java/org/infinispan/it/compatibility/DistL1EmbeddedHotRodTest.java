...
//      Cache<SplitMagicKey, Integer> embedded1 = cacheFactory1.getEmbeddedCache();
//      Cache<SplitMagicKey, Integer> embedded2 = cacheFactory1.getEmbeddedCache();
//      RemoteCache<SplitMagicKey, Integer> remote1 = cacheFactory1.getHotRodCache();
//
//      SplitMagicKey key1 = new SplitMagicKey("Key mapped to node 1", embedded1);
//
//      remote1.put(key1, 1);
//
//      assertEquals(1, embedded1.get(key1).intValue());
//      assertEquals(1, embedded2.get(key1).intValue());
//
//      //assertEquals(1, remote1.get(key1).intValue());
//   }
