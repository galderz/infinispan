...
public final class QueryInterceptor extends DDSequentialInterceptor {
   ...
   public CompletableFuture<Void> visitPutKeyValueCommand(InvocationContext ctx, PutKeyValueCommand command) throws Throwable {
      return ctx.onReturn((ctx1, command1, rv, throwable) -> {
         if (throwable == null) {
            processPutKeyValueCommand(((PutKeyValueCommand) command1), ctx1, rv, null);
         }
         return null;
      });
   }
   ...
   public CompletableFuture<Void> visitRemoveCommand(InvocationContext ctx, RemoveCommand command) throws Throwable {
      ...
      return ctx.onReturn((ctx1, command1, rv, throwable) -> {
         if (throwable == null) {
            processRemoveCommand(((RemoveCommand) command1), ctx1, rv, null);
         }
         return null;
      });
   }
   ...
   public CompletableFuture<Void> visitReplaceCommand(InvocationContext ctx, ReplaceCommand command) throws Throwable {
      return ctx.onReturn((ctx1, command1, rv, throwable) -> {
         if (throwable == null) {
            processReplaceCommand(((ReplaceCommand) command1), ctx1, rv, null);
         }
         return null;
      });
   }
   ...
   public CompletableFuture<Void> visitPutMapCommand(InvocationContext ctx, PutMapCommand command) throws Throwable {
      return ctx.onReturn((ctx1, command1, rv, throwable) -> {
         if (throwable == null) {
            ...
            processPutMapCommand(((PutMapCommand) command1), ctx1, previousValues, null);
         }
         return null;
      });
   }
   ...
   public CompletableFuture<Void> visitClearCommand(final InvocationContext ctx, final ClearCommand command) throws Throwable {
      ...
      return ctx.onReturn((ctx1, command1, rv, throwable) -> {
         if (throwable == null) {
            processClearCommand(((ClearCommand) command1), ctx1, null);
         }
         return null;
      });
   }
         ...
         if (throwable == null) {
            if (ctx.isTransactionValid()) {
               ...
               for (int i = 0; i < writeCommands.length; i++) {
                  final WriteCommand writeCommand = writeCommands[i];
                  if (writeCommand instanceof PutKeyValueCommand) {
                     processPutKeyValueCommand((PutKeyValueCommand) writeCommand, ctx, stateBeforePrepare[i],
                           transactionContext);
                  } else if (writeCommand instanceof PutMapCommand) {
                     processPutMapCommand((PutMapCommand) writeCommand, ctx,
                           (Map<Object, Object>) stateBeforePrepare[i], transactionContext);
                  } else if (writeCommand instanceof RemoveCommand) {
                     processRemoveCommand((RemoveCommand) writeCommand, ctx, stateBeforePrepare[i],
                           transactionContext);
                  } else if (writeCommand instanceof ReplaceCommand) {
                     processReplaceCommand((ReplaceCommand) writeCommand, ctx, stateBeforePrepare[i],
                           transactionContext);
