...
public class PessimisticLockingInterceptor extends AbstractTxLockingInterceptor {
   private static final CompletableFuture<Object> COMPLETED_FALSE = CompletableFuture.completedFuture(false);
   private static final CompletableFuture<Object> COMPLETED_TRUE = CompletableFuture.completedFuture(true);
   ...
   protected final CompletableFuture<Void> visitDataReadCommand(InvocationContext ctx, DataCommand command) throws Throwable {
      ctx.onReturn((ctx1, command1, rv, throwable) -> {
         if (throwable != null) {
            releaseLocksOnFailureBeforePrepare(ctx1);
            throw throwable;
         }
      ...
      return ctx.forkInvocation(lcc, (ctx1, command1, rv, throwable) -> {
         if (throwable != null) {
            throw throwable;
         }
   ...
   public CompletableFuture<Void> visitGetAllCommand(InvocationContext ctx, GetAllCommand command)
      ...
      return ctx.forkInvocation(lcc, (ctx1, command1, rv, throwable) -> {
         ...
         return acquireLocalLocks(ctx1, (LocalFlagAffectedCommand) command1, keys);
      });
   }
   ...
   public CompletableFuture<Void> visitPutMapCommand(InvocationContext ctx, PutMapCommand command) throws
      ...
      ctx.onReturn((ctx1, command1, rv, throwable) -> {
         if (throwable != null) {
            rethrowAndReleaseLocksIfNeeded(ctx1, throwable);
         }
      ...
      return ctx.forkInvocation(lcc, (ctx1, command1, rv, throwable) -> {
         ...
         return acquireLocalLocks(ctx1, (LocalFlagAffectedCommand) command1, affectedKeys);
      });
   }
   ...
   public CompletableFuture<Void> visitApplyDeltaCommand(InvocationContext ctx, ApplyDeltaCommand command) throws Throwable {
      ...
      if (needRemoteLocks(ctx, keysToLock, command)) {
         ...
         return ctx.forkInvocation(lcc, (ctx1, command1, rv, throwable) -> {
            ...
            ((TxInvocationContext<?>) ctx1).addAllAffectedKeys(keysToLock);
            acquireLocalCompositeLocks(command, keysToLock, ctx1);
            return ctx.continueInvocation();
         });
      } else {
   ...
   public CompletableFuture<Void> visitLockControlCommand(TxInvocationContext ctx, LockControlCommand command) throws Throwable {
      ...
      return ctx.onReturn((ctx1, command1, rv, throwable) -> {
         ...
         return CompletableFuture.completedFuture(localLockCommandWork(ctx1, command));
      });
   }
