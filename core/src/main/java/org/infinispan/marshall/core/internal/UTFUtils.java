...
public final class UTFUtils {
    ...
    */
   public static void writeUTFBytes(final ObjectOutput output, final String s) throws IOException {
    ...
    * @see java.io.DataInput#readUTF()
    */
   public static String readUTFBytes(final ObjectInput input, final int len) throws IOException {
      final byte[] byteBuf = BYTES_HOLDER.get();
    ...
    * @see java.io.DataInput#readUTF()
    */
   public static String readUTFBytesByByteCount(final ObjectInput input, final long len) throws IOException {
    ...
    * @see java.io.DataInput#readUTF()
    */
   public static String readUTFZBytes(final ObjectInput input) throws IOException {
      final StringBuilder builder = new StringBuilder();
      for (;;) {
   ...
   private static int readUTFChar(final ObjectInput input) throws IOException {
      final int a = input.read();
      if (a < 0) {
         throw new EOFException();
      } else if (a == 0) {
